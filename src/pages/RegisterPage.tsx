        ...
        <div className="min-h-screen flex items-center justify-center bg-slate-50 dark:bg-slate-900 p-4">
            <div className="glass-card max-w-md w-full p-8 rounded-2xl flex flex-col gap-6">
                <div>
                    ...
                    <p className="text-slate-500">Sign up to sync tasks across all your devices natively.</p>
                </div>
                ...
                <form onSubmit={handleRegister} className="flex flex-col gap-4">
                    <input
                        type="email" placeholder="Email (admin@... sets admin role natively)" required
                    ...
                    />
                    <button type="submit" className="btn-primary py-3">Register</button>
                </form>

                <p className="text-center text-slate-500 text-sm">
                    Already have an account? <Link to="/login" className="text-brand-500 underline">Log in instead.</Link>
                </p>
            </div>
        </div>
    );
